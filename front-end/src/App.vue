<template>
  <div id="app">
    <!-- Navigation-->
    <nav
      v-bind:class="{ 'navbar-shrink': onTop }"
      ...
      <div class="container px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link" href="/#about">Academy</a>
            </li>
            <li class="nav-item">
    ...
    <footer class="footer container">
      ...
      <span class="text-muted">
        Created by Santiago Gomez Paz | Repo
        <a href="https://github.com/gomezpaz/study-like-mad">here</a>
      </span>
    </footer>
  </div>
</template>
